...
Elems_list  = {'Si' ,'Al' , 'Cr',    'Ti'     ,'Fe'   ,'Mn',    'Mg',    'Ca',   'Na',    'K','S', 'C',   'H',  'O'  };
Oxide_list = {'SiO2','Al2O3','Cr2O3','TiO2',  'FeO'  ,'MnO',    'MgO',  'CaO',  'Na2O', 'K2O','S2', 'CO2', 'H2O' };
...
noxy   = [2      3      3        2        1       1         1        1       1        1  0   2    1       ];
ncat   = [1      2      2        1        1       1         1        1       2        2  2   1    2       ];
% molmOx = [60.084  101.961 151.9904 79.8658  71.844  70.93744  40.304  56.077 61.97894 xxx  94.196  18.01528];
NsysOx = molOx(~O_ind);
