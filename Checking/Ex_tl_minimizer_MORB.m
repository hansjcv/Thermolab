...
nO        =  0.467;
Cmol_oxy  = [50.086 8.691 11.671 12.145 7.784 0.215 2.498 1.006  5.437];
...
db_name   = 'tc-ds62';
sol_name  = {'Amphibole','Olivine','Orthopyroxene','Augite','Feldspar','Spinel','Muscovite','Epidote','Garnet','Melt(G16)','Ilmenite','Chlorite'};
pure_name = {'H2O','cz','q','per','lime','ky','sill','and','cor','ru','sph'};for i_pure = 1:length(pure_name),pure_name{i_pure} = [pure_name{i_pure},',',db_name];end
